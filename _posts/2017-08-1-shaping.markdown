...
---
---
How can cultural heritage institutions develop and provide access to collections that are more readily amenable to computational use? How does the movement towards computationally amenable collections prompt an opportunity to reframe, enrich, and/or contextualize collections in a manner that seeks to avoid replication of long standing biases inherent in collection practice? The **Collections as Data** project presents **Shaping Humanities Data** as a venue to explore these questions at Digital Humanities 2017.
